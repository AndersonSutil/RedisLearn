...
import com.example.cardnumber.randomcardnum.config.DistributedLocker;
import com.example.cardnumber.randomcardnum.config.LockExecutionResult;
...
public class RedisService {
    ...
    @Autowired
    public RedisService(DistributedLocker locker) {
        this.locker = locker;
    }
